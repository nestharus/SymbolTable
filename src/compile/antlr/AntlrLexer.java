...
public class AntlrLexer extends Lexer
{
	...
	public static final int                       SCRIPT              = 1, WS = 2, COMMENTS = 3, ARGUMENTS = 4, ANY = 5, CHAR_SEQUENCE = 6,
	        STRING_SEQUENCE = 7, STRING_SEQUENCE2 = 8, STRING_SEQUENCE3 = 9, PARAM_START = 10, PRE_START = 11, String_PRE_START = 12,
	        String_SEQUENCE = 13, String_END = 14, String2_PRE_START = 15, String2_SEQUENCE = 16, String2_END = 17, String3_PRE_START = 18,
	        String3_SEQUENCE = 19, String3_END = 20, Arguments_WS = 21, Arguments_RBRACK = 22, Arguments_ARGUMENT = 23, Param_ANY = 24,
	        Param_PARAM_START = 25, Param_END = 26, Param_PRE_START = 27, ImportStart_WS = 28, ImportStart_Parens = 29, Import_WS = 30,
	        Import_FILE = 31, Imporg_ARG_READ = 32, Import_END = 33, ImportArg_WS = 34, ImportArg_ARG = 35, ImportArg_ARG_READ = 36,
	        ImportArg_END = 37, Arg_WS = 38, Arg_VAL = 39, EvalStart_WS = 40, EvalStart_Parens = 41, Eval_WS = 42, Eval_EXPR = 43,
	        Eval_EXPR_PARENS = 44, Eval_END = 45, EvaluateStart_WS = 46, EvaluateStart_Parens = 47, Evaluate_WS = 48, Evaluate_EXPR = 49,
	        Evaluate_EXPR_PARENS = 50, Evaluate_END = 51, Package_WS = 52, Package_FILE = 53, Package_FILE_READ = 54, Package_END = 55,
	        PackageArg_WS = 56, PackageArg_ARG = 57, PackageArg_ARG_READ = 58, PackageArg_END = 59, Pre_WS = 60, Pre_IMPORT_START = 61,
	        Pre_PACKAGE_START = 62, Pre_ARG_START = 63, Pre_EVAL_START = 64, Pre_EVAL = 65, Pre_END = 66, PreEnd_WS = 67, PreEnd_End = 68;
	...
	public static String[]                        modeNames           = { "DEFAULT_MODE", "Normal", "String", "String2", "String3",
	        "Arguments", "Param", "ImportStart", "Import", "ImportArg", "Arg", "EvalStart", "Eval", "EvaluateStart", "Evaluate", "Package",
	        "PackageArg", "Pre", "PreEnd"                            };

	public static final String[]                  tokenNames          = { "<INVALID>", "SCRIPT", "WS", "COMMENTS", "'#<arguments>'", "ANY",
	        "CHAR_SEQUENCE", "STRING_SEQUENCE", "STRING_SEQUENCE2", "STRING_SEQUENCE3", "PARAM_START", "PRE_START", "String_PRE_START",
	        "String_SEQUENCE", "String_END", "String2_PRE_START", "String2_SEQUENCE", "String2_END", "String3_PRE_START",
	        "String3_SEQUENCE", "String3_END", "Arguments_WS", "'#<end>'", "Arguments_ARGUMENT", "Param_ANY", "Param_PARAM_START", "']'",
	        "Param_PRE_START", "ImportStart_WS", "ImportStart_Parens", "Import_WS", "Import_FILE", "Imporg_ARG_READ", "Import_END",
	        "ImportArg_WS", "ImportArg_ARG", "ImportArg_ARG_READ", "ImportArg_END", "Arg_WS", "Arg_VAL", "EvalStart_WS",
	        "EvalStart_Parens", "Eval_WS", "Eval_EXPR", "Eval_EXPR_PARENS", "Eval_END", "EvaluateStart_WS", "EvaluateStart_Parens",
	        "Evaluate_WS", "Evaluate_EXPR", "Evaluate_EXPR_PARENS", "Evaluate_END", "Package_WS", "Package_FILE", "Package_FILE_READ",
	        "Package_END", "PackageArg_WS", "PackageArg_ARG", "PackageArg_ARG_READ", "PackageArg_END", "Pre_WS", "'import'",
	        "Pre_PACKAGE_START", "'$'", "'if'", "'evaluate'", "'end'", "PreEnd_WS", "'>'" };
	public static final String[]                  ruleNames           = { "WS", "COMMENTS", "ARGUMENTS", "ANY", "CHAR_SEQUENCE",
	        "STRING_SEQUENCE", "STRING_SEQUENCE2", "STRING_SEQUENCE3", "PARAM_START", "PRE_START", "String_PRE_START", "String_SEQUENCE",
	        "String_END", "String2_PRE_START", "String2_SEQUENCE", "String2_END", "String3_PRE_START", "String3_SEQUENCE", "String3_END",
	        "Arguments_WS", "Arguments_RBRACK", "Arguments_ARGUMENT", "Param_ANY", "Param_PARAM_START", "Param_END", "Param_PRE_START",
	        "ImportStart_WS", "ImportStart_Parens", "Import_WS", "Import_FILE", "Imporg_ARG_READ", "Import_END", "ImportArg_WS",
	        "ImportArg_ARG", "ImportArg_ARG_READ", "ImportArg_END", "Arg_WS", "Arg_VAL", "EvalStart_WS", "EvalStart_Parens", "Eval_WS",
	        "Eval_EXPR", "Eval_EXPR_PARENS", "Eval_END", "EvaluateStart_WS", "EvaluateStart_Parens", "Evaluate_WS", "Evaluate_EXPR",
	        "Evaluate_EXPR_PARENS", "Evaluate_END", "Package_WS", "Package_FILE", "Package_FILE_READ", "Package_END", "PackageArg_WS",
	        "PackageArg_ARG", "PackageArg_ARG_READ", "PackageArg_END", "Pre_WS", "Pre_IMPORT_START", "Pre_PACKAGE_START", "Pre_ARG_START",
	        "Pre_EVAL_START", "Pre_EVAL", "Pre_END", "PreEnd_WS", "PreEnd_End" };
	...
	private void error(final String message)
	{
		...
		getErrorListenerDispatch().syntaxError(AntlrLexer.this, null, _tokenStartLine, _tokenStartCharPositionInLine,
		                                       message + ": " + getCurrentText(), null);
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex)
	{
		...
		{
			case 2:
				ARGUMENTS_action((RuleContext) _localctx, actionIndex);
				break;
			...
			case 4:
				CHAR_SEQUENCE_action((RuleContext) _localctx, actionIndex);
				break;

			case 5:
				STRING_SEQUENCE_action((RuleContext) _localctx, actionIndex);
				break;

			case 6:
				STRING_SEQUENCE2_action((RuleContext) _localctx, actionIndex);
				break;

			case 7:
				STRING_SEQUENCE3_action((RuleContext) _localctx, actionIndex);
				break;

			case 8:
				PARAM_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 9:
				PRE_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 10:
				String_PRE_START_action((RuleContext) _localctx, actionIndex);
				break;
			...
			case 13:
				String2_PRE_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 14:
				String2_SEQUENCE_action((RuleContext) _localctx, actionIndex);
				break;

			case 15:
				String2_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 16:
				String3_PRE_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 17:
				String3_SEQUENCE_action((RuleContext) _localctx, actionIndex);
				break;

			case 18:
				String3_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 19:
				Arguments_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 20:
				Arguments_RBRACK_action((RuleContext) _localctx, actionIndex);
				break;

			case 21:
				Arguments_ARGUMENT_action((RuleContext) _localctx, actionIndex);
				break;

			case 22:
				Param_ANY_action((RuleContext) _localctx, actionIndex);
				break;

			case 23:
				Param_PARAM_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 24:
				Param_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 25:
				Param_PRE_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 26:
				ImportStart_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 27:
				ImportStart_Parens_action((RuleContext) _localctx, actionIndex);
				break;
			...
			case 29:
				Import_FILE_action((RuleContext) _localctx, actionIndex);
				break;

			case 30:
				Imporg_ARG_READ_action((RuleContext) _localctx, actionIndex);
				break;

			case 31:
				Import_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 32:
				ImportArg_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 33:
				ImportArg_ARG_action((RuleContext) _localctx, actionIndex);
				break;

			case 34:
				ImportArg_ARG_READ_action((RuleContext) _localctx, actionIndex);
				break;

			case 35:
				ImportArg_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 36:
				Arg_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 37:
				Arg_VAL_action((RuleContext) _localctx, actionIndex);
				break;

			case 38:
				EvalStart_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 39:
				EvalStart_Parens_action((RuleContext) _localctx, actionIndex);
				break;

			case 40:
				Eval_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 41:
				Eval_EXPR_action((RuleContext) _localctx, actionIndex);
				break;

			case 42:
				Eval_EXPR_PARENS_action((RuleContext) _localctx, actionIndex);
				break;

			case 43:
				Eval_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 44:
				EvaluateStart_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 45:
				EvaluateStart_Parens_action((RuleContext) _localctx, actionIndex);
				break;

			case 46:
				Evaluate_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 47:
				Evaluate_EXPR_action((RuleContext) _localctx, actionIndex);
				break;

			case 48:
				Evaluate_EXPR_PARENS_action((RuleContext) _localctx, actionIndex);
				break;

			case 49:
				Evaluate_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 50:
				Package_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 51:
				Package_FILE_action((RuleContext) _localctx, actionIndex);
				break;

			case 52:
				Package_FILE_READ_action((RuleContext) _localctx, actionIndex);
				break;

			case 53:
				Package_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 54:
				PackageArg_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 55:
				PackageArg_ARG_action((RuleContext) _localctx, actionIndex);
				break;

			case 56:
				PackageArg_ARG_READ_action((RuleContext) _localctx, actionIndex);
				break;

			case 57:
				PackageArg_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 58:
				Pre_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 59:
				Pre_IMPORT_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 60:
				Pre_PACKAGE_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 61:
				Pre_ARG_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 62:
				Pre_EVAL_START_action((RuleContext) _localctx, actionIndex);
				break;

			case 63:
				Pre_EVAL_action((RuleContext) _localctx, actionIndex);
				break;

			case 64:
				Pre_END_action((RuleContext) _localctx, actionIndex);
				break;

			case 65:
				PreEnd_WS_action((RuleContext) _localctx, actionIndex);
				break;

			case 66:
				PreEnd_End_action((RuleContext) _localctx, actionIndex);
				break;
		}
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex)
	{
		...
		{
			case 60:
				return Pre_PACKAGE_START_sempred((RuleContext) _localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\2F\u02a4\b\1\b\1\b"
